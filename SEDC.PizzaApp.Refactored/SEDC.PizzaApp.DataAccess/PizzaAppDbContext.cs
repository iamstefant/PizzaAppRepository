...
namespace SEDC.PizzaApp.DataAccess
{
    ...
    public class PizzaAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Users>() //main table
               .HasMany(x => x.Orders); // 1-m relation (many side)
            ...
            modelBuilder.Entity<Users>()
                ...
                {
                    Id = 1,
                    FirstName = "Afroddasdasita",
                    LastName = "Bedsadsadasle",
                    Address = "Address1"
                },
                new Users
                {
                    Id = 2,
                    FirstName = "Stdasasefan",
                    LastName = "Tradasdasjanoski",
                    Address = "Adddasasddsaress2"
