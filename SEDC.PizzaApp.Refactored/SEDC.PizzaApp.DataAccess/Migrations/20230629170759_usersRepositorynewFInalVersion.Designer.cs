...
namespace SEDC.PizzaApp.DataAccess.Migrations
{
    ...
    [Migration("20230629170759_usersRepositorynewFInalVersion")]
    partial class usersRepositorynewFInalVersion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SEDC.PizzaApp.Domain.Models.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SEDC.PizzaApp.Domain.Models.Order", b =>
                {
                    ...
                    b.HasOne("SEDC.PizzaApp.Domain.Models.Users", null)
                        .WithMany("Orders")
